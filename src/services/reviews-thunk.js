...
import {findLastNReviewsByUser} from "./reviews-service";
...
export const findLastNReviewsByUserThunk = createAsyncThunk(
    'findLastNReviewsByUser', async ({uid, limit}) => await service.findLastNReviewsByUser(uid, limit)
);